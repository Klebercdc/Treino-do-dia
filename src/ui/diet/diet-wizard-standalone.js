...
(function(root) {
  ...
  function injectStyles(doc) {
    ...
    style.textContent = [
      ...
      '@media(max-width:430px){.kdw-card{padding:22px 18px}.kdw-grid{grid-template-columns:1fr}.kdw-card h2{font-size:25px}.kdw-footer{position:sticky;bottom:0;background:linear-gradient(180deg,rgba(2,6,23,0),#020617 30%);padding-top:14px}}'
    ].join('');
