...
(function(){
  ...
  function renderDietFromPlan(plan){
    ...
    $('kdpNewDiet').onclick = function(){ closeDietPlanVisual(); if(window.KroniaDiet && typeof window.KroniaDiet.createPlan==='function') window.KroniaDiet.createPlan(); else if(typeof window.createDietPlan==='function') window.createDietPlan(); };
    return true;
  }
