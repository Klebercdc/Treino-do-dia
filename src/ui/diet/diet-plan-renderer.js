...
(function(){
  ...
  function renderDietFromPlan(plan){
    ...
    ensureStyles();
    ['dietProfileWizardScreen','nutritionFlowScreen','dietDataScreen','dietChoiceScreen','dietResultScreen','dietGeneratedScreen'].forEach(function(id){
      var el = $(id);
      if(!el) return;
