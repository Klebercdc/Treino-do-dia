...
var FOOD_OVERRIDES = {
  ...
  'coxao_mole_magro': { kcal: 175, protein: 26, carbs: 0, fat: 7, portion: 120, unitLabel: '120 g' },
  'musculo_cozido': { kcal: 170, protein: 25, carbs: 0, fat: 7, portion: 120, unitLabel: '120 g' },
  'carne_moida_magra': { kcal: 185, protein: 26, carbs: 0, fat: 9, portion: 120, unitLabel: '120 g', tags: ['facil_preparo'] },
  // Suínos
  'lombo_suino_assado': { kcal: 162, protein: 25, carbs: 0, fat: 6, portion: 120, unitLabel: '120 g' },
  'file_mignon_suino': { kcal: 155, protein: 26, carbs: 0, fat: 5, portion: 120, unitLabel: '120 g' },
  'pernil_magro_desfiado': { kcal: 170, protein: 24, carbs: 0, fat: 8, portion: 120, unitLabel: '120 g' },
  // Peixes brancos
  'tilapia_grelhada': { kcal: 128, protein: 26, carbs: 0, fat: 2.7, portion: 140, unitLabel: '140 g' },
  'merluza_assada': { kcal: 115, protein: 23, carbs: 0, fat: 1.5, portion: 140, unitLabel: '140 g' },
  ...
  // Frutos do mar
  'camarao_cozido': { kcal: 85, protein: 18, carbs: 0.2, fat: 0.9, portion: 100, unitLabel: '100 g' },
  ...
  'tempeh': { kcal: 193, protein: 19, carbs: 9, fat: 11, fiber: 5, portion: 100, unitLabel: '100 g', tags: ['vegano', 'vegetariano'] },
  'seitan': { kcal: 120, protein: 21, carbs: 5, fat: 2, fiber: 0, portion: 100, unitLabel: '100 g', tags: ['vegetariano'] },
  'edamame': { kcal: 110, protein: 11, carbs: 9, fat: 5, fiber: 4, portion: 100, unitLabel: '100 g', tags: ['vegano'] },
  'grao_de_bico_cozido': { kcal: 164, protein: 9, carbs: 27, fat: 2.6, fiber: 7.6, portion: 100, unitLabel: '100 g', tags: ['vegano'] },
  'lentilha_cozida': { kcal: 116, protein: 9, carbs: 20, fat: 0.4, fiber: 8, portion: 100, unitLabel: '100 g', tags: ['vegano'] },
  'feijao_preto_cozido': { kcal: 132, protein: 9, carbs: 24, fat: 0.5, fiber: 8.7, portion: 100, unitLabel: '100 g', tags: ['vegano'] },
  // Suplementos
  ...
  'trigo_sarraceno_cozido': { kcal: 92, protein: 3.4, carbs: 20, fat: 0.6, fiber: 2.7, portion: 120, unitLabel: '120 g' },
  // Tubérculos
  'batata_doce_cozida': { kcal: 86, protein: 1.6, carbs: 20, fat: 0.1, fiber: 3, portion: 130, unitLabel: '130 g', tags: ['pre_treino'] },
  'batata_inglesa_cozida': { kcal: 87, protein: 1.9, carbs: 20, fat: 0.1, fiber: 1.8, portion: 150, unitLabel: '150 g' },
  'mandioca_cozida': { kcal: 134, protein: 1, carbs: 32, fat: 0.3, fiber: 1.9, portion: 120, unitLabel: '120 g' },
  'inhame_cozido': { kcal: 118, protein: 1.5, carbs: 28, fat: 0.2, fiber: 4, portion: 120, unitLabel: '120 g' },
  'mandioquinha_cozida': { kcal: 79, protein: 1.3, carbs: 18, fat: 0.2, fiber: 2, portion: 120, unitLabel: '120 g' },
  // Massas
  ...
  'creme_de_arroz': { kcal: 350, protein: 7, carbs: 78, fat: 0.5, fiber: 0.6, portion: 30, unitLabel: '30 g' },
  ...
  'banana_prata': { kcal: 89, protein: 1.1, carbs: 23, fat: 0.3, fiber: 2.6, portion: 90, unitLabel: '1 un média', tags: ['pre_treino'] },
  'uva': { kcal: 67, protein: 0.6, carbs: 17, fat: 0.4, fiber: 0.9, portion: 120, unitLabel: '120 g' },
  'uva_rubi': { kcal: 67, protein: 0.6, carbs: 17, fat: 0.4, fiber: 0.9, portion: 120, unitLabel: '120 g' },
  'manga': { kcal: 60, protein: 0.8, carbs: 15, fat: 0.4, fiber: 1.6, portion: 120, unitLabel: '120 g' },
  'manga_palmer': { kcal: 60, protein: 0.8, carbs: 15, fat: 0.4, fiber: 1.6, portion: 120, unitLabel: '120 g' },
  ...
  'pera': { kcal: 57, protein: 0.4, carbs: 15, fat: 0.1, fiber: 3.1, portion: 140, unitLabel: '1 un média' },
  'ameixa': { kcal: 46, protein: 0.7, carbs: 11, fat: 0.3, fiber: 1.4, portion: 120, unitLabel: '2 unidades' },
  'laranja': { kcal: 47, protein: 0.9, carbs: 12, fat: 0.1, fiber: 2.4, portion: 150, unitLabel: '1 unidade' },
  'mamao': { kcal: 43, protein: 0.5, carbs: 11, fat: 0.3, fiber: 1.8, portion: 150, unitLabel: '1 fatia' },
  'melao': { kcal: 34, protein: 0.8, carbs: 8, fat: 0.2, fiber: 0.9, portion: 150, unitLabel: '150 g' },
  'abacaxi': { kcal: 50, protein: 0.5, carbs: 13, fat: 0.1, fiber: 1.4, portion: 130, unitLabel: '130 g' },
  'pessego': { kcal: 39, protein: 0.9, carbs: 10, fat: 0.3, fiber: 1.5, portion: 120, unitLabel: '1 unidade' },
  'caqui': { kcal: 70, protein: 0.6, carbs: 19, fat: 0.2, fiber: 3.6, portion: 120, unitLabel: '1 unidade' },
  // Gorduras
  'azeite_de_oliva': { kcal: 884, protein: 0, carbs: 0, fat: 100, fiber: 0, portion: 10, unitLabel: '1 colher de sopa' },
  'oleo_de_abacate': { kcal: 884, protein: 0, carbs: 0, fat: 100, fiber: 0, portion: 10, unitLabel: '1 colher de sopa' },
  'oleo_de_coco': { kcal: 892, protein: 0, carbs: 0, fat: 100, fiber: 0, portion: 10, unitLabel: '1 colher de sopa' },
  'castanhas': { kcal: 600, protein: 15, carbs: 20, fat: 50, fiber: 8, portion: 20, unitLabel: '1 punhado' },
  'amendoas': { kcal: 579, protein: 21, carbs: 22, fat: 50, fiber: 12.5, portion: 20, unitLabel: '20 g' },
  'nozes': { kcal: 654, protein: 15, carbs: 14, fat: 65, fiber: 6.7, portion: 20, unitLabel: '3-4 unidades' },
  'castanha_do_para': { kcal: 659, protein: 14, carbs: 12, fat: 67, fiber: 7.5, portion: 20, unitLabel: '2 unidades' },
  'pistache': { kcal: 562, protein: 20, carbs: 28, fat: 45, fiber: 10.6, portion: 20, unitLabel: '20 g' },
  'sementes_de_chia': { kcal: 486, protein: 17, carbs: 42, fat: 31, fiber: 34, portion: 15, unitLabel: '1 colher de sopa' },
  'linhaca': { kcal: 534, protein: 18, carbs: 29, fat: 42, fiber: 27, portion: 15, unitLabel: '1 colher de sopa' },
  'semente_de_abobora': { kcal: 559, protein: 30, carbs: 11, fat: 49, fiber: 6, portion: 20, unitLabel: '20 g' },
  'gergelim': { kcal: 573, protein: 17, carbs: 23, fat: 50, fiber: 11.8, portion: 10, unitLabel: '1 colher de sopa' },
  'pasta_de_amendoim': { kcal: 588, protein: 25, carbs: 20, fat: 50, fiber: 6, portion: 20, unitLabel: '1 colher de sopa' },
  'pasta_de_amendoas': { kcal: 579, protein: 21, carbs: 22, fat: 50, fiber: 12.5, portion: 20, unitLabel: '20 g' },
  'tahine': { kcal: 595, protein: 17, carbs: 21, fat: 54, fiber: 9, portion: 15, unitLabel: '1 colher de sopa' },
  ...
  'couve_de_bruxelas': { kcal: 36, protein: 3, carbs: 7, fat: 0.5, fiber: 3.8, portion: 100, unitLabel: '100 g' },
  'cenoura_cozida': { kcal: 35, protein: 0.8, carbs: 8.2, fat: 0.2, fiber: 2.9, portion: 100, unitLabel: '100 g' },
  'abobrinha_refogada': { kcal: 17, protein: 1.2, carbs: 3.1, fat: 0.3, fiber: 1, portion: 100, unitLabel: '100 g' },
  'berinjela_assada': { kcal: 25, protein: 0.8, carbs: 5.9, fat: 0.2, fiber: 3, portion: 100, unitLabel: '100 g' },
  'chuchu_cozido': { kcal: 19, protein: 0.8, carbs: 4.5, fat: 0.1, fiber: 1.9, portion: 100, unitLabel: '100 g' },
  'vagem_cozida': { kcal: 31, protein: 1.8, carbs: 7, fat: 0.1, fiber: 2.7, portion: 100, unitLabel: '100 g' },
  'pepino': { kcal: 12, protein: 0.6, carbs: 2.2, fat: 0.1, fiber: 0.7, portion: 100, unitLabel: '100 g' },
  'salada_verde': { kcal: 20, protein: 1, carbs: 3, fat: 0.2, fiber: 2, portion: 100, unitLabel: '1 prato' },
  'alface': { kcal: 15, protein: 1.4, carbs: 2.3, fat: 0.2, fiber: 1.3, portion: 100, unitLabel: '1 prato' },
  ...
  'bebida_vegetal_de_aveia': { kcal: 46, protein: 1, carbs: 7.8, fat: 1.5, fiber: 0.8, portion: 200, unitLabel: '200 ml' },
  'leite': { kcal: 61, protein: 3.2, carbs: 4.8, fat: 3.3, portion: 200, unitLabel: '200 ml' },
  'leite_desnatado': { kcal: 35, protein: 3.4, carbs: 5, fat: 0.1, portion: 200, unitLabel: '200 ml' },
  'leite_zero_lactose': { kcal: 61, protein: 3.2, carbs: 4.8, fat: 3.3, portion: 200, unitLabel: '200 ml' },
  'iogurte_grego_natural_lac': { kcal: 76, protein: 10, carbs: 3.6, fat: 2.3, portion: 170, unitLabel: '170 g' },
  'kefir_natural': { kcal: 61, protein: 3.3, carbs: 4.8, fat: 3.3, portion: 170, unitLabel: '170 g' },
  'queijo_minas_frescal': { kcal: 95, protein: 6.8, carbs: 2, fat: 6.6, portion: 80, unitLabel: '2 fatias' },
  'ricota': { kcal: 173, protein: 11, carbs: 3, fat: 13, portion: 100, unitLabel: '100 g' },
  'cottage_lac': { kcal: 98, protein: 11, carbs: 3.4, fat: 4.3, portion: 170, unitLabel: '170 g', tags: ['high_protein'] },
  'iogurte_zero_lactose': { kcal: 61, protein: 3.5, carbs: 4.7, fat: 3.3, portion: 170, unitLabel: '170 g' },
  'queijo_zero_lactose': { kcal: 95, protein: 6.8, carbs: 2, fat: 6.6, portion: 80, unitLabel: '80 g' },
};
