/**
 * KRONIA — Edge Function: telegram-bot
 * =====================================
 ...
 *   curl "https://api.telegram.org/bot<TOKEN>/setWebhook?url=https://kefenskszivdbfrhqsnd.supabase.co/functions/v1/telegram-bot"
 */
...
async function send(chatId: number, text: string) {
  ...
  if (!res.ok) {
    ...
    console.error("[telegram-bot] sendMessage error:", JSON.stringify(err));
